...
# When true, export all Infisical secrets (recursive) into runtime env.
# Used by both moovent-stack (local runner) and mqtt_dashboard_watch (Render loader).
INFISICAL_EXPORT_ALL_ENV = "INFISICAL_EXPORT_ALL"
